...
public class SendEmail {
    private String from = "18756665811@163.com"; // 发件人邮箱地址
    private String user = "18756665811@163.com"; // 发件人称号，同邮箱地址
    private String password = "yuanshuo312"; // 发件人邮箱客户端授权码
    ...
    public static void main(String[] args) { // 做测试用
        ...
        ds.sendMail("15761632038@163.com", "你好，这是一封测试邮件，无需回复。", "测试邮件");
    }
}
